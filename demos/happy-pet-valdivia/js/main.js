/* ══════════════════════════════════════════════════════════════════
   HAPPY PET · Valdivia — demo 161
   JS clasico, un IIFE, sin dependencias.

   Las filas de la farmacia son <details> nativos: abren y cierran sin
   escritos en el HTML: si este archivo no llega, la noche se lee
   entera. En esta pagina eso importa mas que en ninguna otra.
...
(function () {
  ...
  var piezas = [];
  ['.reloj--foto', '.reloj__caja', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.noche', '.alta', '.cierre', '.dueno__cols']
