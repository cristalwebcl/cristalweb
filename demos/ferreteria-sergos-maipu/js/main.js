/* Ferretería Sergos — main.js
   IIFE, JS clásico, sin librerías, sin type="module" (rompe en file://).
   Hace tres cosas: cancelar el rescate, la cabecera fantasma, las
   apariciones al scrollear y abrir los cajones de la portada.
   Nada del contenido depende de este archivo: las ocho familias y lo
   que hay en cada una están escritas en el HTML. */
(function () {
  'use strict';
  ...
  var grupos = document.querySelectorAll(
    '.ancho > .rotulo, .ancho > .titulo, .cifras__grid, .fam__grid, .mae__grid, ' +
  ...
  /* ── Escena: los cajones se abren ───────────────────────────────── */
  /* Se observa la .escena entera y no los cajones: la cara lateral
     empieza con scaleX(0), o sea con área cero, y un elemento de área
     cero NUNCA dispara el IntersectionObserver.
     Pasa una vez y quedan abiertos. Con menos movimiento, ya abiertos. */
