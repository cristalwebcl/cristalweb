/* Hospital Veterinario Alto la Florida — main.js
   ...
   apariciones al scrollear y encender el letrero de la portada.
   Nada del contenido depende de este archivo: el teléfono, el protocolo
   de la madrugada y los servicios están escritos en el HTML. Si este
   script no llega, el letrero se ve encendido y la página se lee
   completa. */
(function () {
  'use strict';
  ...
  var grupos = document.querySelectorAll(
    '.cifras__grid, .tri, .serv, .llegar__grid, .mitades__texto, ' +
  ...
  /* ── Escena: el letrero se dibuja y después se enciende ──────────── */
  /* Se observa la .escena entera y no los trazos: un trazo con
     stroke-dashoffset completo tiene área pintada cero y NUNCA
     dispararía el IntersectionObserver. Pasa una vez y queda encendido:
     un neón de hospital no titila. Con menos movimiento, ya encendido. */
