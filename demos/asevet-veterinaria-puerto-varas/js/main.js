/* ══════════════════════════════════════════════════════════════════
   ...
   Sin JavaScript la página se lee entera: el tablero de los siete días
   es una lista normal, la guía de urgencias son tres listas y la
...
(function () {
  ...
  var piezas = [];
  ['.cifras', '.semana .ancho', '.tablero', '.tajo__txt', '.urgencia .ancho',
   '.urg__c', '.consulta .ancho', '.cita__txt', '.mos .ancho', '.mos__grilla',
  ...
  /* ── 3 · Contar el caso ──
     La clínica no publica teléfono y CristalWeb todavía no tiene
