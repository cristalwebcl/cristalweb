/* ══════════════════════════════════════════════════════════════════
   EL BOSQUE · Valdivia — demo 164
   JS clasico, un IIFE, sin dependencias.

   Las filas de la farmacia son <details> nativos: abren y cierran sin
   archivo no llega, la maniobra se lee entera: lo unico que se pierde
   son los ojos del fondo, que son adorno.
...
(function () {
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.esc__cuerpo', '.amiga__cuerpo', '.cierre', '.dueno__cols']
