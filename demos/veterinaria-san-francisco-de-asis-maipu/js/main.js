/* Veterinaria San Francisco de Asís II — main.js
   ...
   apariciones al scrollear y soltar el peso en la balanza.
   Nada del contenido depende de este archivo: la hoja del carnet —que
   es lo que se imprime— está escrita en el HTML y se imprime igual con
   el script apagado. */
(function () {
  'use strict';
  ...
  var grupos = document.querySelectorAll(
    '.portada__cif, .hoja__datos, .fichas, .mitades__texto, ' +
  ...
  /* ── Escena: la balanza ─────────────────────────────────────────
     Se observa la .escena entera y no el peso: arranca con opacity 0 y
     desplazado, y la secuencia —cae y después oscila— es una sola
     cosa. Pasa una vez. Con menos movimiento queda el peso puesto y la
     viga derecha. ── */
