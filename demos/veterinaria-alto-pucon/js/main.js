/* ══════════════════════════════════════════════════════════════════
   VETERINARIA ALTO PUCON · Pucon — demo 159
   JS clasico, un IIFE, sin dependencias.

   Las filas de la farmacia son <details> nativos: abren y cierran sin
   navegacion entre tramos funciona sin JavaScript. Si este archivo no
   llega, se pierde el humo del volcan y nada mas.
...
(function () {
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.montana__intro', '.indice', '.tramo', '.vuelta__cuerpo', '.cierre', '.dueno__cols']
