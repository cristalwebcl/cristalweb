/* ═══════════════════════════════════════════════════════════════════
   BERACA SERVICIO AUTOMOTRIZ · Temuco
   ...
   El papel continuo de la portada NO está acá: es UN @keyframe de CSS
   sobre tres degradados. No se congela en pestañas de fondo y no cuesta
   un solo evento. La banda perforada de la cabecera es un degradado
   radial repetido, también sin código.
   ═══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     pauta de mantención, que es a lo que viene la gente:
