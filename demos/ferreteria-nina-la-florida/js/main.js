/* Ferretería Nina — main.js
   ...
   apariciones al scrollear y armar la cañería de la portada.
   Nada del contenido depende de este archivo: las siete piezas del
   glosario y los datos están escritos en el HTML. Si el script no
   llega, la cañería se ve armada y la página se lee entera. */
(function () {
  'use strict';
  ...
  var grupos = document.querySelectorAll(
    '.portada__cif, .gl, .fichas, .meson__l, .mos__grilla, ' +
  ...
  /* ── Escena: las piezas se conectan ─────────────────────────────
     Se observa la .escena entera y no las piezas: arrancan desplazadas
     y con opacity 0, y la secuencia completa es lo que importa. Pasa
     una vez y queda armada. Con menos movimiento, armada de entrada. ── */
