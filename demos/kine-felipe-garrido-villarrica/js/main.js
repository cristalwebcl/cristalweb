/* ══════════════════════════════════════════════════════════════════
   FELIPE GARRIDO · Villarrica — demo 175
   JS clasico, un IIFE, sin dependencias.

   Sin JavaScript la pagina se lee entera: la ficha, la visita y las
   cuatro razones estan escritas en el HTML. Lo unico que se pierde
   es el camino que se enciende.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.casa__fluye', '.ficha', '.persona__cabecera', '.rz', '.cierre', '.dueno__cols']
