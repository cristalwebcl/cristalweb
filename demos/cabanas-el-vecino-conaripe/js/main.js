...
(function () {
  ...
  /* ── 2 · Apariciones al entrar en pantalla ──
     Las tres ventanas del pueblo se encienden con retardo desde el CSS
     (transition-delay): este archivo solo pone la clase .ok. Sin JS
     quedan encendidas de entrada, que es como deben verse. */
  var piezas = [];
  ['.lam__texto', '.pueblo', '.cierre', '.dueno__cols'].forEach(function (sel) {
