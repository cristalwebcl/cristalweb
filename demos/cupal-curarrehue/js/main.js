/* ══════════════════════════════════════════════════════════════════
   CUPAL RESTAURANT · Curarrehue — demo 145
...
(function () {
  ...
  /* ── 2 · Apariciones al entrar en pantalla ──
     La tabla NO se anima fila por fila a proposito: es la pieza
     principal y tiene que estar completa apenas entra a cuadro. */
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.galeria__titulo', '.gal', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.horas__cabecera', '.tabla-envoltura', '.ojo',
   '.llevar__cuerpo', '.cierre', '.dueno__cols'].forEach(function (sel) {
