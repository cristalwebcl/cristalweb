/* SD Salón Concept — main.js
   ...
   apariciones al scrollear y disparar la escena del mechón.
...
(function () {
  ...
  var grupos = document.querySelectorAll(
    '.guia > .ancho:first-child, .hace > .ancho, .mitades__texto, ' +
    '.hace__grid, .guia__tabla, .evaluacion, .tira__lista, ' +
    '.mos__grilla, .equipo__huecos, .donde__cols, .dueno__cols'
  );
  ...
  /* ── Escena: el mechón se dibuja ────────────────────────────────── */
  /* Se observa la .escena entera y no cada marca: un círculo en scale(0)
     mide cero y un elemento de área cero NUNCA dispara el
     IntersectionObserver — se quedaría invisible para siempre.
     Pasa una vez y queda quieta. Con menos movimiento, ya puesta. */
