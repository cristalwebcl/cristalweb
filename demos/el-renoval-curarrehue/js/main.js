/* ══════════════════════════════════════════════════════════════════
   EL RENOVAL · Curarrehue — demo 147
...
(function () {
  ...
  /* ── 2 · Apariciones al entrar en pantalla ──
     La carta NO se anima linea por linea a proposito: es la pieza
     principal y tiene que estar completa apenas entra a cuadro. */
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.galeria__titulo', '.gal', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.carta__cabecera', '.cafes', '.atajos',
   '.pausa__cuerpo', '.cierre', '.dueno__cols'].forEach(function (sel) {
