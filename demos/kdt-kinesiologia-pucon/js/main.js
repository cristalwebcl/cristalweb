/* ══════════════════════════════════════════════════════════════════
   ...
   Sin JavaScript la pagina se lee entera: los cinco criterios y las
   dos listas del visitante estan escritos en el HTML. Lo unico que
   se pierde es el segundero del fondo.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.portada', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.portada__texto', '.galeria__titulo', '.gal', '.volver__cabecera', '.sp', '.dura', '.visita__cabecera', '.cl', '.informe', '.cierre', '.dueno__cols']
