/* ═══════════════════════════════════════════════════════════════════
   CABAÑAS EL CONQUISTADOR · Licán Ray
   ...
   El oleaje de la portada NO está acá: son @keyframes de CSS que
   combinan traslación y escala. No se congela en pestañas de fondo y
   no cuesta un solo evento. La línea de costa de la cabecera son dos
   degradados radiales repetidos, también sin código.
   ═══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
