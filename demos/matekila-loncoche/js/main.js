/* ══════════════════════════════════════════════════════════════════
   MATEKILA · Loncoche — demo 185
   JS clasico, un IIFE, sin dependencias.

   Sin JavaScript la pagina se lee entera: los dos mostradores con
   sus fichas y los cuatro pasos del envase estan escritos en el
   HTML. Lo unico que se pierde son las jabas apilandose.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.mostradores__cabecera', '.col', '.envase__cabecera', '.pa', '.cierre', '.dueno__cols']
