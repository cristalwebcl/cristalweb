/* ══════════════════════════════════════════════════════════════════
   SUELO NATIVO · Curarrehue — demo 146
   JS clasico, un IIFE, sin dependencias.

   OJO: los cuatro capitulos de estacion estan escritos en el HTML y
   no dependen de este archivo. Si main.js no llega, el ano del huerto
   se lee entero, con sus cuatro iniciales.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.error__cuerpo', '.huerto__cabecera', '.grupos', '.anio__cabecera', '.estaciones', '.reservar', '.dueno__cols']
