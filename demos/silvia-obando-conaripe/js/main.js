/* ══════════════════════════════════════════════════════════════════
   CABAÑAS COÑARIPE · SILVIA OBANDO — demo 155
   JS clasico, un IIFE, sin dependencias.

   Esta demo es T1 CON NOMBRE y no tiene formulario: el contacto es el
   telefono, escrito en el HTML como enlace tel:. Este archivo no
   participa en el contacto de ninguna forma.
...
(function () {
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.donde__cuerpo', '.terreno__cuerpo', '.cierre', '.dueno__cols']
