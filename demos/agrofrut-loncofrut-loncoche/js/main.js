/* ═══════════════════════════════════════════════════════════════════
   AGROFRUT · Cooperativa Loncofrut · Loncoche
   ...
   Los surcos de la portada NO están acá: es UN @keyframe de CSS sobre
   un degradado repetido. No se congela en pestañas de fondo y no cuesta
   un solo evento. La costura de saco de la cabecera son dos líneas y
   un pespunte, también sin código.
   ═══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     calendario del año, que es a lo que viene la gente:
