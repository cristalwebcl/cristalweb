...
(function () {
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════════ */
  var elQue     = document.getElementById('f-lista');
  var elCuando  = document.getElementById('f-sector');
  ...
  if (elQue && elCuando && elResumen) {
    var armar = function () {
      var texto = 'Hola, quiero un despacho a la obra.\n' +
                  'Lista: '   + (elQue.value.trim()    || '(sin escribir)') + '\n' +
                  'Obra: '    + (elCuando.value.trim() || '(sin escribir)');
  ...
  var piezas = [].slice.call(document.querySelectorAll(
    '.portada__texto > *, .ruta__cabecera > *, .tramo, ' +
    '.lista__cuerpo > *, .pasos li, .dueno__cols > div'
  ));
