/* ══════════════════════════════════════════════════════════════════
   ...
   OJO: las cinco fichas de ingredientes NO dependen de este archivo.
   Estan escritas en el HTML, incluida la barra de meses. Si este
   archivo no llega, la pieza firma se lee completa.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.glosario__cabecera', '.fichas', '.temporada__cuerpo', '.dueno__cols']
