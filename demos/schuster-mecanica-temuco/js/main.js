/* ══════════════════════════════════════════════════════════════════
   SCHUSTER · Temuco — demo 180
   JS clasico, un IIFE, sin dependencias.

   Sin JavaScript la pagina se lee entera: la tabla de la revision
   es una <table> de verdad y esta escrita en el HTML. Lo unico que
   se pierde es la tuerca del fondo.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.portada', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.portada__texto', '.galeria__titulo', '.gal', '.revision__cabecera', '.tabla-envoltura', '.antes', '.apellido__cabecera', '.fi', '.cierre', '.dueno__cols']
