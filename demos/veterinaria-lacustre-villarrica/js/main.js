/* ══════════════════════════════════════════════════════════════════
   ...
   cuatro sitios (barra fija, cabecera, portada y cierre) como enlace
   tel:. En una pagina de urgencia eso no es opcional.
...
(function () {
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.cinco__cuerpo', '.urgencia__cuerpo', '.cierre', '.dueno__cols']
