/* Salón Dchamas — main.js
   IIFE, JS clásico, sin librerías, sin type="module" (rompe en file://).
   Hace tres cosas: cancelar el rescate, la cabecera fantasma, las
   apariciones al scrollear y llenar los frascos de la portada.

   OJO: los tres pasos de la pieza firma NO están acá. Son radio buttons
   y :checked en el CSS, a propósito: funcionan con el JavaScript
   apagado y se recorren con el teclado. */
(function () {
  'use strict';
  ...
  var grupos = document.querySelectorAll(
    '.ancho > .rotulo, .ancho > .titulo, .cifras__grid, .loc__grid, .zonas, ' +
  ...
  /* ── Escena: los frascos se llenan ──────────────────────────────── */
  /* Se observa la .escena entera y no cada líquido: un rect con
     scaleY(0) mide cero de alto, y un elemento de área cero NUNCA
     dispara el IntersectionObserver — se quedaría vacío para siempre.
     Pasa una vez y quedan llenos. Con menos movimiento, ya llenos. */
