/* Taller Mecánico El Zapato — main.js
   ...
   apariciones al scrollear y encender el tablero de la portada.
   Nada del contenido depende de este archivo: los seis testigos con
   qué significan y qué hacer están escritos en el HTML. Si el script
   no llega, se ve el tablero con el verde encendido y la página se lee
   entera. */
(function () {
  'use strict';
  ...
  var grupos = document.querySelectorAll(
    '.portada__cif, .tl, .fichas, .mitades__texto, .mos__grilla, ' +
  ...
  /* ── Escena: el tablero al dar contacto ──────────────────────────
     Se observa la .escena entera y no los testigos: arrancan con
     opacity .13, y de todas formas es la secuencia completa la que
     importa, no cada luz. Pasa una vez y queda el verde. Con menos
     movimiento no se anima nada: queda el estado final. ── */
