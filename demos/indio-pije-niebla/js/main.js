/* ══════════════════════════════════════════════════════════════════
   INDIO PIJE · Niebla — demo 142
   JS clasico, un IIFE, sin dependencias.

   OJO: el poster de la portada NO depende de este archivo. La palabra
   del pescado del dia esta ESCRITA en el HTML: se cambia editando una
   linea. Si este archivo no llega, el poster se ve igual.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.poster__marco', '.pescado__cabecera', '.especies', '.origen', '.fritura', '.fuerte__cuerpo', '.dueno__cols']
