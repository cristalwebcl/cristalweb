/* ══════════════════════════════════════════════════════════════════
   VETERINARIA PITRUFQUEN — demo 167
   JS clasico, un IIFE, sin dependencias.

   Sin JavaScript la pagina se lee entera: los cuatro capitulos
   estan escritos en el HTML. Lo unico que se pierde es la firma que
   se traza y la transparencia de la cabecera, que son adorno.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.portada', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.portada__texto', '.cap__cuerpo', '.fachada', '.cierre', '.dueno__cols']
