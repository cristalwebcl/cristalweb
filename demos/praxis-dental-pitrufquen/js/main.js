/* ═══════════════════════════════════════════════════════════════════
   ...
   El eco de la portada NO está acá: son @keyframes de CSS con cuatro
   anillos expandiéndose. No se congela en pestañas de fondo y no
   cuesta un solo evento. La cabecera flotante es puro CSS, también sin
   código.
   ═══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
