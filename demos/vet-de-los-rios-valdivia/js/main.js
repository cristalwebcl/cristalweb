/* ══════════════════════════════════════════════════════════════════
   DE LOS RIOS · Valdivia — demo 163
   JS clasico, un IIFE, sin dependencias.

   Las filas de la farmacia son <details> nativos: abren y cierran sin
   llega, el proceso completo se lee igual: lo unico que se pierde es
   el revelado de la placa, que es adorno.
...
(function () {
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.cap__cuerpo', '.cap__n', '.papeles__cuerpo', '.cierre', '.dueno__cols']
