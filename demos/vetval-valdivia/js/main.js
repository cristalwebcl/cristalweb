/* ══════════════════════════════════════════════════════════════════
   ...
   HTML. Si este archivo no llega, se leen completas: lo unico que se
   pierde es la banda de satinado, que es adorno.
...
(function () {
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.cuanto__cuerpo', '.consulta__cabecera', '.specs-envoltura', '.cierre', '.dueno__cols']
