/* ═══════════════════════════════════════════════════════════════════
   EmbaPack — Gerónimo de Alderete 800
   ...
   Esta demo NO tiene cabecera de ninguna clase: lo primero de la
   página es la cinta de embalaje y los destinos van dentro de la
   portada, abajo. La cinta se mueve con keyframes de CSS, no desde acá.
   Por eso este archivo sólo trae reveals, parallax y huecos de foto.
   ═══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
