/* ═══════════════════════════════════════════════════════════════════
   Lubricentro SR · demo 132 (tanda P3)
...
(function () {
  ...
  if (elQue && elCuando && elResumen) {
    var armar = function () {
      var texto = 'Hola, quiero pedir hora para un cambio de aceite.\n' +
  ...
  var piezas = [].slice.call(document.querySelectorAll(
    '.portada__texto > *, .cambio__cabecera > *, .paso, ' +
    '.sticker__cuerpo > *, .clave, .dueno__cols > div'
  ));
