/* Clínica Veterinaria Clavero Vet — main.js
   ...
   apariciones al scrollear y hacer respirar la silueta de la portada.
   Nada del contenido depende de este archivo: la tabla por edad, los
   servicios y los datos están escritos en el HTML. Si el script no
   llega, la silueta se ve quieta y la página se lee entera. */
(function () {
  'use strict';
  ...
  var grupos = document.querySelectorAll(
    '.etapas, .serv__grid, .urg__l, .mitades__texto, .mos__grilla, ' +
  ...
  /* ── Escena: la silueta respira ─────────────────────────────────
     Se observa la .escena entera y no el path: la silueta arranca con
     opacity 0, y es el contenedor el que manda de todas formas. Es el
     ÚNICO bucle de la página y es lento a propósito. Con menos
     movimiento, queda quieta y visible. ── */
