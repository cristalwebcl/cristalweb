/* ══════════════════════════════════════════════════════════════════
   VETERINARIA PIUVET · Villarrica — demo 158
   JS clasico, un IIFE, sin dependencias.

   Las filas de la farmacia son <details> nativos: abren y cierran sin
   archivo no llega, el calendario se lee completo: lo unico que se
   pierde es la pelota, que es adorno.
...
(function () {
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.tajo', '.mos__p', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.anio__cabecera', '.tabla-envoltura', '.destroza__cuerpo', '.cierre', '.dueno__cols']
