/* ═══════════════════════════════════════════════════════════════════
   Automotriz COBA · demo 131 (tanda P3)
...
(function () {
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════════ */
  var elQue     = document.getElementById('f-auto');
  var elCuando  = document.getElementById('f-pasa');
  ...
  if (elQue && elCuando && elResumen) {
    var armar = function () {
      var texto = 'Hola, tengo una pana.\n' +
                  'Auto: '    + (elQue.value.trim()    || '(sin escribir)') + '\n' +
                  'Qué pasa: '+ (elCuando.value.trim() || '(sin escribir)');
  ...
  var piezas = [].slice.call(document.querySelectorAll(
    '.portada__texto > *, .casas__cabecera > *, .col, .aviso, ' +
    '.turista__cuerpo > *, .pasos li, .dueno__cols > div'
  ));
