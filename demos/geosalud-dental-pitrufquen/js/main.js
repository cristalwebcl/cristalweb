/* ══════════════════════════════════════════════════════════════════
   GEOSALUD DENTAL · Pitrufquen — demo 171
   JS clasico, un IIFE, sin dependencias.

   Sin JavaScript la pagina se lee entera, y lo mas importante de
   todo —el numero y los tres pasos— esta escrito en el HTML. Lo
   unico que se pierde es la escarcha que crece.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.portada', '.mitades__texto', '.mitades__foto', '.cita__texto', '.tira__pieza', '.portada__texto', '.galeria__titulo', '.gal', '.mientras', '.urgencia__cabecera', '.caja', '.hora__cabecera', '.pr', '.cierre', '.dueno__cols']
